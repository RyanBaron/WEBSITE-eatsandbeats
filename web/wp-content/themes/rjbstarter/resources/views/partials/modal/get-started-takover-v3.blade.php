...
<section id="get-started-rjbstarter-v3" class="bg-lighter get-started-takeover get-started-takeover-v3 page-takeover {!! $bg_img_class !!} {!! $bg_img_opts !!}" tabindex="-1" role="dialog" aria-labelledby="actionPlanModal" aria-hidden="true" {!! $style !!}>
  <div class="get-started-takover-inside page-takeover-inside h-100 d-flex align-items-center flex-wrap">
    <div class="container container-main-content py-2">
      <div class="row flex-row text-right justify-content-center gutter-xxl mb-4">
        <div class="col col-12 col-lg-12"><a class="close takeover-close" href="#get-started-v3"><i class="fal fa-times"></i></a></div>
      </div>
                ...
                <div class="row flex-row row-cards align-items-start justify-content-start ">
                  <div class="col col-card col-12 py-0">
                    <div class="col-inside col-inside-card h-100 py-1 col-inside-fa-2x col-inside-icon-pos-left">
                      <a class="wrapper-link card-wrapper-link" href="{!! __('/products/choice-consent-management-platform/','sage') !!}" data-g-action="choice" data-g-label="get started takeover v1">
                            ...
                            <div class="card-body d-flex flex-column justify-content-md-between h-100 justify-content-between p-1">
                              ...
                              <div class="d-flex flex-column h-100 justify-content-md-start">
                                ...
                                <div class="buttons buttons-cards text-right">
                                  <div class="link link-primary icon-after wrapped-link">Sign up for free <i class="fal fa-arrow-right"></i></div>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  <div class="col col-card col-12 py-0">
                    <div class="col-inside col-inside-card h-100 py-1 col-inside-fa-2x col-inside-icon-pos-left">
                      <a class="wrapper-link card-wrapper-link" href="{!! __('/products/measure-audience-insights/','sage') !!}" data-g-action="measure" data-g-label="get started takeover v1">
                        <div class="card h-100 d-flex flex-column justify-content-md-between  flat dropshadow no-border light-border padding-wrap-1 text-left hl-xs ">
                          <div class="wrapper-card-content d-flex justify-content-md-between h-100 flex-column">
                            <div class="card-body d-flex flex-column justify-content-md-between h-100 justify-content-between p-1">
                              <div class="icon-wrapper icon-wrap-icon-pos-left icon-wrap-fa-2x icon-wrap-icon-gray">
                  ...
                  <div class="col col-card col-12 py-0">
                    <div class="col-inside col-inside-card h-100 py-1 col-inside-fa-2x col-inside-icon-pos-left">
                      <a class="wrapper-link card-wrapper-link" href="{!! __('/products/q-for-publishers/','sage') !!}" data-g-action="q for publishers" data-g-label="get started takeover v1">
                        <div class="card h-100 d-flex flex-column justify-content-md-between  flat dropshadow no-border light-border padding-wrap-1 text-left hl-xs ">
                          <div class="wrapper-card-content d-flex justify-content-md-between h-100 flex-column">
                            <div class="card-body d-flex flex-column justify-content-md-between h-100 justify-content-between p-1">
                              <div class="icon-wrapper icon-wrap-icon-pos-left icon-wrap-fa-2x icon-wrap-icon-gray">
                              ...
                              <div class="d-flex flex-column h-100 justify-content-md-start">
                                ...
                                <div class="buttons buttons-cards text-right">
                                  <div class="link link-primary icon-after wrapped-link">Learn more <i class="fal fa-arrow-right"></i></div>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  <div class="col col-card col-12 py-0">
                    <div class="col-inside col-inside-card h-100 py-1 col-inside-fa-2x col-inside-icon-pos-left">
                      <a class="wrapper-link card-wrapper-link" href="{!! __('/products/advertise/','sage') !!}" data-g-action="advertise" data-g-label="get started takeover v1">
                        <div class="card h-100 d-flex flex-column justify-content-md-between  flat dropshadow no-border light-border padding-wrap-1 text-left hl-xs ">
                          <div class="wrapper-card-content d-flex justify-content-md-between h-100 flex-column">
                            <div class="card-body d-flex flex-column justify-content-md-between h-100 justify-content-between p-1">
                              <div class="icon-wrapper icon-wrap-icon-pos-left icon-wrap-fa-2x icon-wrap-icon-gray">
