<div class="container">
  <div id="subNavRow" class="sub-nav-row sub-nav-taxonomy sub-nav-category sub-nav-taxonomy-customer row flex-row subnav-row justify-content-start mt-0 mt-lg-1 d-none d-lg-flex">
    <div class="col">
