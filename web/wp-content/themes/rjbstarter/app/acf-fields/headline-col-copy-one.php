...
$headline
  ->addCheckbox('col_copy_one_headline_options')
  ...
  ->addSelect('col_copy_one_headline_tag')
    ->setLabel('Headline Tag')
    ->conditional('col_copy_one_headline_options', '==', 'headline')
      ->or('col_copy_one_headline_options', '==', 'superheadline')
      ->or('col_copy_one_headline_options', '==', 'subheadline')
    ->addChoices($headline_tag_options)
  ->addSelect('col_copy_one_headline_style')
    ->setLabel('Headline Style')
    ->conditional('col_copy_one_headline_options', '==', 'headline')
      ->or('col_copy_one_headline_options', '==', 'superheadline')
      ->or('col_copy_one_headline_options', '==', 'subheadline')
    ->addChoices($headline_style_options)
  ->addImage('col_copy_one_pre_headline_image', $args_image)
    ->setLabel('Pre Headline Image')
    ->conditional('col_copy_one_headline_options', '==', 'pre-headline-image')
  ->addSelect('col_copy_one_pre_headline_image_width')
    ->setLabel('Pre Headline Image Width')
    ->conditional('col_copy_one_headline_options', '==', 'pre-headline-image')
    ->addChoices($image_width_options)
  ->addSelect('col_copy_one_pre_headline_image_size')
    ->setLabel('Pre Headline Image Size')
    ->conditional('col_copy_one_headline_options', '==', 'pre-headline-image')
    ->addChoices(array('small', 'medium', 'large', 'full'))
  ->addText('col_copy_one_superheadline', $args_superheadline)
    ->setLabel('Superheadline')
    ->conditional('col_copy_one_headline_options', '==', 'superheadline')
  ->addText('col_copy_one_headline', $args_headline)
    ->setLabel('Headline')
    ->conditional('col_copy_one_headline_options', '==', 'headline')
  ->addText('col_copy_one_subheadline', $args_subheadline)
    ->setLabel('Subheadline')
    ->conditional('col_copy_one_headline_options', '==', 'subheadline')
  ->addImage('col_copy_one_post_headline_image', $args_image)
    ->setLabel('Post Headline Image')
    ->conditional('col_copy_one_headline_options', '==', 'post-headline-image')
  ->addSelect('col_copy_one_post_headline_image_width')
    ->setLabel('Post Headline Image Width')
    ->conditional('col_copy_one_headline_options', '==', 'post-headline-image')
    ->addChoices($image_width_options)
  ->addSelect('col_copy_one_post_headline_image_size')
