...
<section id="get-started-rjbstarter" class="bg-lighter get-started-takeover page-takeover {!! $bg_img_class !!} {!! $bg_img_opts !!}" tabindex="-1" role="dialog" aria-labelledby="actionPlanModal" aria-hidden="true" {!! $style !!}>
      ...
      <div class="row flex-row row-cards justify-content-center  text-center">
        <div class="col col-card">
          <div class="col-inside col-inside-card h-100 py-2">
            <a class="wrapper-link card-wrapper-link" href="https://rjbstarter.lndo.site/products/advertise/" data-g-action="" data-g-label="">
        ...
        <div class="col col-card">
          <div class="col-inside col-inside-card h-100 py-2  ">
            <a class="wrapper-link card-wrapper-link" href="https://rjbstarter.lndo.site/products/choice-consent-management-platform-alt/" data-g-action="" data-g-label="">
              <div class="card h-100 d-flex flex-column justify-content-md-between     ">
                <div class="wrapper-card-content d-flex justify-content-md-between h-100 flex-column">
                  <div class="card-body d-flex flex-column justify-content-md-between h-100 justify-content-between">
                    <div class="d-flex flex-column h-100 justify-content-md-start">
