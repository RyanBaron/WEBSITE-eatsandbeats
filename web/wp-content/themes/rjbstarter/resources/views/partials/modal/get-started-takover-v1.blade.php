...
<section id="get-started-rjbstarter-v1" class="bg-lighter get-started-takeover get-started-takeover-v1 page-takeover {!! $bg_img_class !!} {!! $bg_img_opts !!}" tabindex="-1" role="dialog" aria-labelledby="actionPlanModal" aria-hidden="true" {!! $style !!}>
