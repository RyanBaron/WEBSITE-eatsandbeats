=== Quantcast Choice ===
Version: 2.0.2
Contributors: rbaronqc, davidfornelli
...
**TCF v2.0 Update**
**August, 9, 2020 Plugin Update**
Now supporting **TCF v2.0**, **CCPA**, **theme customisation**, **Non-IAB vendor support**, **vendor customisation**, **and more**.

The Quantcast Choice Plugin is an easy way to automatically add the [Quantcast Choice TCF v2.0 Consent Management Platform (CMP)](https://www.quantcast.com/gdpr/consent-management-solution/?utm_source=wordpress&utm_medium=wp-org&utm_campaign=info&utm_term=tool&utm_content=choice) to your WordPress website.  In addition to adding Quantcast Choice to your website this plugin also makes it easy to push consent signals to the Data Layer and add a CCPA support to your website footer.
