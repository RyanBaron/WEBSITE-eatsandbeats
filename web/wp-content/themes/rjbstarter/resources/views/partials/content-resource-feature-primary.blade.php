@php
  ...
  $g_label_prefix = isset($args['g_label_prefix']) && ! empty( $args['g_label_prefix'] ) ? $args['g_label_prefix'] : 'resource';
...
@if ( $post_id )
  <a href="{{ get_permalink($post_id) }}" class="wrapper-link" {!! $g_data !!}>
    <article @php post_class('article-feature article-feature-primary hl-md') @endphp>
      <div class="row flex-row justify-content-center justify-content-lg-between gutter-xl">
        ...
        <div class="col col-text col-12 col-lg-5 col-xl-5 align-items-center d-flex order-last order-md-first pb-2 pb-lg-0">
          <div class="col-inside col-text-inside w-100">
            ...
            @if( in_array( 'enable-list', $feed_display ) && have_rows('feed_list') )
        ...
        @if( ! empty( $image['id'] ) )
          <div class="col col-image col-12 col-lg-7 order-first order-md-last pt-2 pt-lg-0">
