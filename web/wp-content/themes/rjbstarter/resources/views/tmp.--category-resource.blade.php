  ...
  <div class="bg-lighter blog-feed-content py-6">
    <div class="container">
      <header class="header-content py-6">
        <div class="row">
          <div class="col-12 col-md-6">
            <h3 class="headline headline-header">All Resources</h3>
          </div>
        </div>
      </header>
        ...
        <div class="col col-articles col-12 col-xxl-12">
          ...
          <div id="more-posts">
            ...
            <div id="more-load" class="text-center pt-10 pb-4">
              <a href="javascript:void(0)" data-load-posts="all" class="btn btn-outline-dark icon-after">See more resources <i class="fal fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
      </div>
